<template>
    <b-container fluid class="h-100">
        ...
        <b-row>
            <b-col sm="12" md="6" offset-md="3">
                <b-form-input type="password" size="lg" v-model="form.new_password" placeholder="New Password"></b-form-input>
            </b-col>
        </b-row>

        <b-row>
            <b-col sm="12" md="6" offset-md="3">
                <b-form-input type="password" size="lg" v-model="form.confirm_new_password" placeholder="Confirm Password"></b-form-input>
            </b-col>
        </b-row>
    ...
    export default {
        ...
        methods: {
            changePassword: function () {
                ...
                if (!that.$data.form.password.trim() || !that.$data.form.new_password.trim() || !that.$data.form.change_new_password.trim()) {
                    return;
                }
